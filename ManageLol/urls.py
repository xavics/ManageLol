...
urlpatterns = patterns('',
    ...
    url(r'^media/(?P<path>.*)$', 'django.views.static.serve', {'document_root': settings.BASE_DIR+'/Manager'+settings.MEDIA_URL}),
    ...
    url(r'^open_registers', 'Manager.views.open_registers', name='open_registers'),
    url(r'^generate_competition', 'Manager.views.generate_competition', name='generate_competition'),
    url(r'^close_competition', 'Manager.views.close_competition', name='close_competition'),
)
