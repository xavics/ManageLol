"""
Django settings for ManageLol project.
...
SECRET_KEY = 'a2*sn50zy*6ou7s-+l^d3)pa-@q(@-8tbdqgjhv7ta7gw3amlw'
...
WSGI_APPLICATION = 'ManageLol.wsgi.application'
